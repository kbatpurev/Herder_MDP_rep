...
1. Partially observable transition tables--> Reality or .
...
6. Explicit social networks beyond shared location/herd-size information.
7. Grazing effects on cells crossed during emergency travel.
8. Joint-action Q tables, centralized critics, or deep MARL.
9. Full landscape rollouts / Monte Carlo tree search.
10. Seasonal pasture polygons larger than two designated cells.
11. Endogenous herd demography and persistent carry-forward of livestock losses. Current-period stock survival is implemented, but surviving herd size is not yet a state variable.
